			...
			<div class="modal-body">
				...
				<input type="hidden" id="item-id">
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Drug Name:</label>
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="item-name" placeholder="Enter Drug Name" required="" autofocus="">
				    </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">drug Code:</label>
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="code" placeholder="Enter Drug Code" required="" autofocus="">
				    </div>
				  </div>
